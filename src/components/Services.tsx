import { services, products, type Service } from "@/data/site";

const groupLabels: Record<Service["group"], { label: string; tag: string }> = {
  build: { label: "Build", tag: "Objects · Interiors · Industrial" },
      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-8 py-16 md:py-24 grid grid-cols-12 gap-4 md:gap-8">
        ...
        >
          ...
          <div className="mt-6 p-5 border hairline-strong bg-paper relative overflow-hidden">
            ...
            <a href="#release" className="relative btn-ghost mt-4">
              See current release
            </a>
          </div>
        </aside>
